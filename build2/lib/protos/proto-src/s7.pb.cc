...
const uint32_t TableStruct_s7_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::ConfigSnapSeven_PLCConfig_DataBlockTag, valuetype_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 22, -1, -1, sizeof(::ConfigSnapSeven_PLCConfig_DataBlockTag)},
  { 36, -1, -1, sizeof(::ConfigSnapSeven_PLCConfig_MemoryTag)},
  { 47, -1, -1, sizeof(::ConfigSnapSeven_PLCConfig)},
  { 61, -1, -1, sizeof(::ConfigSnapSeven)},
};
...
const char descriptor_table_protodef_s7_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\020\n\010bitCount\030\006 \001(\005\022\021\n\tbyteCount\030\007 \001(\005\032\243\001"
  ...
  "\006 \001(\005\022\021\n\tValueType\030\007 \001(\t\022\021\n\tBitNumber\030\010 "
  "\001(\005\032h\n\tMemoryTag\022\017\n\007tagName\030\001 \001(\t\022\r\n\005tag"
  "Id\030\002 \001(\t\022\024\n\014functionCode\030\003 \001(\t\022\024\n\014startA"
  "ddress\030\004 \001(\005\022\017\n\007varSize\030\005 \001(\0052`\n\025SystemS"
  "napSevenConfig\022G\n\031SendSystemSnapSevenCon"
  "fig\022\020.ConfigSnapSeven\032\030.SnapSevenConfigR"
  "esponseb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_s7_2eproto = {
  false, false, 935, descriptor_table_protodef_s7_2eproto, "s7.proto", 
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&bytecount_) -
    reinterpret_cast<char*>(&wordcount_)) + sizeof(bytecount_));
}
...
void ConfigSnapSeven_PLCConfig_IoTag::InternalSwap(ConfigSnapSeven_PLCConfig_IoTag* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_IoTag, bytecount_)
      + sizeof(ConfigSnapSeven_PLCConfig_IoTag::bytecount_)
      - PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_IoTag, wordcount_)>(
...
ConfigSnapSeven_PLCConfig_DataBlockTag::ConfigSnapSeven_PLCConfig_DataBlockTag(const ConfigSnapSeven_PLCConfig_DataBlockTag& from)
  ...
  ::memcpy(&dbnumber_, &from.dbnumber_,
    static_cast<size_t>(reinterpret_cast<char*>(&bitnumber_) -
    reinterpret_cast<char*>(&dbnumber_)) + sizeof(bitnumber_));
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&dbnumber_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&bitnumber_) -
    reinterpret_cast<char*>(&dbnumber_)) + sizeof(bitnumber_));
}
...
// @@protoc_insertion_point(message_clear_start:ConfigSnapSeven.PLCConfig.DataBlockTag)
  ...
  ::memset(&dbnumber_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&bitnumber_) -
      reinterpret_cast<char*>(&dbnumber_)) + sizeof(bitnumber_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ConfigSnapSeven_PLCConfig_DataBlockTag::_InternalSerialize(
  ...
  if (!this->_internal_valuetype().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType");
    target = stream->WriteStringMaybeAliased(
        7, this->_internal_valuetype(), target);
  }

  // int32 BitNumber = 8;
  if (this->_internal_bitnumber() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(8, this->_internal_bitnumber(), target);
  }
...
void ConfigSnapSeven_PLCConfig_DataBlockTag::InternalSwap(ConfigSnapSeven_PLCConfig_DataBlockTag* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_DataBlockTag, bitnumber_)
      + sizeof(ConfigSnapSeven_PLCConfig_DataBlockTag::bitnumber_)
      - PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_DataBlockTag, dbnumber_)>(
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&varsize_) -
    reinterpret_cast<char*>(&startaddress_)) + sizeof(varsize_));
}
...
void ConfigSnapSeven_PLCConfig_MemoryTag::InternalSwap(ConfigSnapSeven_PLCConfig_MemoryTag* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_MemoryTag, varsize_)
      + sizeof(ConfigSnapSeven_PLCConfig_MemoryTag::varsize_)
      - PROTOBUF_FIELD_OFFSET(ConfigSnapSeven_PLCConfig_MemoryTag, startaddress_)>(
