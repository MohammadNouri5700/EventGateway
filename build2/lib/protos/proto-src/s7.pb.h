...
class ConfigSnapSeven_PLCConfig_DataBlockTag final :
 ...
 public:
  ...
  enum : int {
    ...
    kValueTypeFieldNumber = 7,
    kDBNumberFieldNumber = 4,
    kStartAddressFieldNumber = 5,
    kVarSizeFieldNumber = 6,
    kBitNumberFieldNumber = 8,
  };
  // string tagName = 1;
  void clear_tagname();
  const std::string& tagname() const;
...
// int32 varSize = 6;
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::clear_varsize() {
  varsize_ = 0;
}
inline int32_t ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_varsize() const {
  return varsize_;
}
inline int32_t ConfigSnapSeven_PLCConfig_DataBlockTag::varsize() const {
  // @@protoc_insertion_point(field_get:ConfigSnapSeven.PLCConfig.DataBlockTag.varSize)
  return _internal_varsize();
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_set_varsize(int32_t value) {
  
  varsize_ = value;
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::set_varsize(int32_t value) {
  _internal_set_varsize(value);
  // @@protoc_insertion_point(field_set:ConfigSnapSeven.PLCConfig.DataBlockTag.varSize)
}

// string ValueType = 7;
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::clear_valuetype() {
  valuetype_.ClearToEmpty();
}
inline const std::string& ConfigSnapSeven_PLCConfig_DataBlockTag::valuetype() const {
  // @@protoc_insertion_point(field_get:ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType)
  return _internal_valuetype();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ConfigSnapSeven_PLCConfig_DataBlockTag::set_valuetype(ArgT0&& arg0, ArgT... args) {
 ...
 valuetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType)
}
inline std::string* ConfigSnapSeven_PLCConfig_DataBlockTag::mutable_valuetype() {
  std::string* _s = _internal_mutable_valuetype();
  // @@protoc_insertion_point(field_mutable:ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType)
  return _s;
}
inline const std::string& ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_valuetype() const {
  return valuetype_.Get();
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_set_valuetype(const std::string& value) {
  
  valuetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_mutable_valuetype() {
  
  return valuetype_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ConfigSnapSeven_PLCConfig_DataBlockTag::release_valuetype() {
  // @@protoc_insertion_point(field_release:ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType)
  return valuetype_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::set_allocated_valuetype(std::string* valuetype) {
  ...
  valuetype_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), valuetype,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (valuetype_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    valuetype_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:ConfigSnapSeven.PLCConfig.DataBlockTag.ValueType)
}
