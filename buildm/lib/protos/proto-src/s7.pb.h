...
inline ::PROTOBUF_NAMESPACE_ID::int32 ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_varsize() const {
  return varsize_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ConfigSnapSeven_PLCConfig_DataBlockTag::varsize() const {
  // @@protoc_insertion_point(field_get:ConfigSnapSeven.PLCConfig.DataBlockTag.varSize)
  return _internal_varsize();
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::_internal_set_varsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  varsize_ = value;
}
inline void ConfigSnapSeven_PLCConfig_DataBlockTag::set_varsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
