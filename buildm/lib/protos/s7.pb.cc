...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 22, -1, sizeof(::ConfigSnapSeven_PLCConfig_DataBlockTag)},
  { 37, -1, sizeof(::ConfigSnapSeven_PLCConfig_MemoryTag)},
  { 49, -1, sizeof(::ConfigSnapSeven_PLCConfig)},
  { 62, -1, sizeof(::ConfigSnapSeven)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_s7_2eproto = {
  &descriptor_table_s7_2eproto_initialized, descriptor_table_protodef_s7_2eproto, "s7.proto", 1228,
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          bitnumber_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 dbNumber = 8;
