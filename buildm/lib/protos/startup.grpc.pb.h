...
class SystemStartupConfig final {
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void SendSystemStartupConfig(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::StartupResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void SendSystemStartupConfig(::grpc::ClientContext* context, const ::StartupConfig* request, ::StartupResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void SendSystemStartupConfig(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::StartupResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
    };
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void SendSystemStartupConfig(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::StartupResponse* response, std::function<void(::grpc::Status)>) override;
      void SendSystemStartupConfig(::grpc::ClientContext* context, const ::StartupConfig* request, ::StartupResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void SendSystemStartupConfig(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::StartupResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_SendSystemStartupConfig : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_SendSystemStartupConfig() {
      ::grpc::Service::experimental().MarkMethodCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::StartupConfig, ::StartupResponse>(
          [this](::grpc::ServerContext* context,
                 const ::StartupConfig* request,
                 ::StartupResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->SendSystemStartupConfig(context, request, response, controller);
                 }));
    }
    void SetMessageAllocatorFor_SendSystemStartupConfig(
        ::grpc::experimental::MessageAllocator< ::StartupConfig, ::StartupResponse>* allocator) {
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::StartupConfig, ::StartupResponse>*>(
          ::grpc::Service::experimental().GetHandler(0))
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_SendSystemStartupConfig() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SendSystemStartupConfig(::grpc::ServerContext* /*context*/, const ::StartupConfig* /*request*/, ::StartupResponse* /*response*/) override {
    ...
    virtual void SendSystemStartupConfig(::grpc::ServerContext* /*context*/, const ::StartupConfig* /*request*/, ::StartupResponse* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  typedef ExperimentalWithCallbackMethod_SendSystemStartupConfig<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_SendSystemStartupConfig : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_SendSystemStartupConfig() {
      ::grpc::Service::experimental().MarkMethodRawCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->SendSystemStartupConfig(context, request, response, controller);
                 }));
    }
    ~ExperimentalWithRawCallbackMethod_SendSystemStartupConfig() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SendSystemStartupConfig(::grpc::ServerContext* /*context*/, const ::StartupConfig* /*request*/, ::StartupResponse* /*response*/) override {
    ...
    virtual void SendSystemStartupConfig(::grpc::ServerContext* /*context*/, const ::grpc::ByteBuffer* /*request*/, ::grpc::ByteBuffer* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_SendSystemStartupConfig() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::StartupConfig, ::StartupResponse>(std::bind(&WithStreamedUnaryMethod_SendSystemStartupConfig<BaseClass>::StreamedSendSystemStartupConfig, this, std::placeholders::_1, std::placeholders::_2)));
    }
